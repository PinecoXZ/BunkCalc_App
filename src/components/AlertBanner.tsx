...
const AlertBanner: React.FC<{ subjects: Subject[] }> = ({ subjects }) => {
  ...
  return (
    <div className="neu-card border border-rose-500/30 rounded-2xl p-4 mb-6 flex items-center gap-3 bg-rose-500/5">
      <div className="neu-flat-sm bg-rose-500/20 text-rose-500 p-2.5 rounded-xl shrink-0">
        <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
          <path fillRule="evenodd" d="M8.257 3.099c.765-1.36 2.722-1.36 3.486 0l5.58 9.92c.75 1.334-.213 2.98-1.742 2.98H4.42c-1.53 0-2.493-1.646-1.743-2.98l5.58-9.92zM11 13a1 1 0 11-2 0 1 1 0 012 0zm-1-8a1 1 0 00-1 1v3a1 1 0 002 0V6a1 1 0 00-1-1z" clipRule="evenodd" />
        </svg>
      </div>
      <div>
        <h4 className="text-rose-600 dark:text-rose-400 font-black text-sm">Danger Zone</h4>
        <p className="text-rose-600/80 dark:text-rose-300/80 text-xs font-medium">
